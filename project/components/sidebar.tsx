		...
		<li className="relative group px-3">
			<Link
				...
				className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring
					${
						isActive
							? "bg-primary/10 text-primary shadow-[inset_0_1px_4px_rgba(0,0,0,0.02)] dark:shadow-[inset_0_1px_4px_rgba(255,255,255,0.02)]" // 1. Depth & Fill
							: "text-muted-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground" // 2. Hover/Focus states using tokens
					}
